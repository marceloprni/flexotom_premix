...
const { Op, Sequelize, QueryTypes} = require("sequelize");
  ...
  async function chamarDadosBarcode(BarcodeIn) {
      ...
      if(!BarcodeIn) {
          throw new ModeloInvalidoErro(404, "Campo Barcode vazio.");
      }
      ...
      if(!dadosBarcode) {
          throw new ModeloInvalidoErro(404, "Não existe lote ou barcode errado.");
      }
    ...
    Status
      ...
      try {
        ...
        if (!LoteId || !MateriaPrimaIdInsumo || !MateriaPrimaInsumo || !Status) {
          throw new ModeloInvalidoErro(400, "Campos obrigatórios preencher.");
        }
